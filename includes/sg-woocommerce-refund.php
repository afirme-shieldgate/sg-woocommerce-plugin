...
class WC_Shieldgate_Refund
{
  function refund($order_id)
  {
    $refundObj = new WC_Gateway_Shieldgate();
    ...
    $transactionCode = WC_Shieldgate_Database_Helper::select_order($order_id);
    $data = array(
        'id' => $transactionCode
    );
    ...
    WC_Shieldgate_Database_Helper::insert_data($status, $comments, $description, $order_id, $transactionCode);
  }
}
